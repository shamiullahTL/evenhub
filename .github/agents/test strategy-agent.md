...
2. `eventhub-domain.md` skill — Overview, architecture, and data models (tells you what lives where)
3. `playwright-best-practices` skill — E2E standards
4. Backend source: `backend/src/services/`, `backend/src/controllers/` — Scan to discover functions/endpoints for unit and API layer decisions
5. Frontend source: `frontend/app/`, `frontend/components/` — Scan to identify components for component-level test decisions
6. Existing tests: `tests/*.spec.js`
