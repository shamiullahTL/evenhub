...
2. `eventhub-domain.md` skill — Overview and data models
3. `tests/*.spec.js` — Existing tests to match patterns
4. `frontend/app/`, `frontend/components/` — Verify selectors exist in actual source code
